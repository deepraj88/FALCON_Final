...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename fv_sc_A \
    op interface \
    ports { fv_sc_A_address0 { O 5 vector } fv_sc_A_ce0 { O 1 bit } fv_sc_A_we0 { O 1 bit } fv_sc_A_d0 { O 64 vector } fv_sc_A_q0 { I 64 vector } fv_sc_A_address1 { O 5 vector } fv_sc_A_ce1 { O 1 bit } fv_sc_A_we1 { O 1 bit } fv_sc_A_d1 { O 64 vector } fv_sc_A_q1 { I 64 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'fv_sc_A'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename r \
    op interface \
    ports { r_address0 { O 10 vector } r_ce0 { O 1 bit } r_q0 { I 8 vector } } \
} "
} else {
