...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.solve_NTRU_intermediate.autotvin_fk_logn.dat"
         "c.solve_NTRU_intermediate.autotvin_fk_tmp.dat"
         "c.solve_NTRU_intermediate.autotvin_f.dat"
         "c.solve_NTRU_intermediate.autotvin_g.dat"
         "c.solve_NTRU_intermediate.autotvin_depth.dat"
         "c.solve_NTRU_intermediate.autotvout_fk_tmp.dat"
         "c.solve_NTRU_intermediate.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.solve_NTRU_intermediate.autotvout_fk_tmp.dat"
         "rtl.solve_NTRU_intermediate.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
