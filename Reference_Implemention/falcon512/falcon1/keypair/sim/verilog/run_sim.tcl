...
if {[file isfile solve_NTRU_intermediate.autotvin.dat]} {
	file delete -force solve_NTRU_intermediate.autotvin.dat
}

if {[file isfile solve_NTRU_intermediate.autotvout.dat]} {
	file delete -force solve_NTRU_intermediate.autotvout.dat
}
