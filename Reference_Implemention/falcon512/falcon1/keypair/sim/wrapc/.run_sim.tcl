...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "solve_NTRU_intermediate.autotvin.dat"
	set constFileTvOut       "solve_NTRU_intermediate.autotvout.dat"
	set constFileHdlTvIn     "solve_NTRU_intermediate.autohdltvin.dat"
	set constFileHdlTvOut    "solve_NTRU_intermediate.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
