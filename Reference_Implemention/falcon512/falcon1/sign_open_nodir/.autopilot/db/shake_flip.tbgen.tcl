...
set C_modelArgList {
	...
	{ sc_A int 64 regular {array 25 { 2 3 } 1 1 }  }
}
...
set Spec2ImplPortList { 
	...
	sc_A { ap_memory {  { sc_A_address0 mem_address 1 5 }  { sc_A_ce0 mem_ce 1 1 }  { sc_A_we0 mem_we 1 1 }  { sc_A_d0 mem_din 1 64 }  { sc_A_q0 mem_dout 0 64 } } }
}
